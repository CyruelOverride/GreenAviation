...
const Home = () => {
  ...
  // Scroll a la sección descripción cuando la URL tiene #seccion-descripcion
  useEffect(() => {
    if (window.location.hash === '#seccion-descripcion') {
      const el = document.getElementById('seccion-descripcion');
  ...
  return (
    <div className="home">
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            <a href="https://wa.me/59899123456" target="_blank" rel="noopener noreferrer" className="btn-primary">Comenzar curso</a>
            <a
      ...
      <section id="seccion-descripcion" className="description-section">
        <div className="description-content">
          <h2 className="section-title">Nuestro Compromiso con tu Formación</h2>
          <p className="description-text">
            <strong>Del primer clic a tu licencia:</strong> Reunimos en éste campus virtual la información que te llevará a tu Licencia de Piloto: clases online de alta calidad, videos explicativos que acompañan el estudio teórico.
          </p>
          <p className="description-text">
            <strong>Preparación para la Dinacia:</strong> Preparación sólida para el examen escrito de la Dinacia y el entrenamiento práctico que transforma conocimiento en competencia.
          </p>
          <p className="description-text">
            <strong>Camino acompañado:</strong> Un camino claro, acompañado por nuestros Instructores, diseñado para que avances con seguridad, eficiencia y confianza.
          </p>
          <p className="description-text">
            <strong>Instrucción de primer nivel:</strong> Nuestro campus integra instrucción online de primer nivel; cada etapa del camino está pensada para que desarrolles criterio, seguridad y la confianza de volar al alto nivel.
          </p>
          <p className="description-text">
            <strong>Dónde nacen los pilotos:</strong> Aquí es donde nacen los pilotos que marcan la diferencia.
          </p>
        </div>
      </section>
      ...
      <section className="info-section">
        <div className="info-content">
          ...
          <div className="social-links">
            <a href="https://www.facebook.com/greenaviation2020/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://wa.me/59899123456" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.instagram.com/greenaviation.salto/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
